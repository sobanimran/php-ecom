            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        ...
                        <?php
                            $qu_prod=mysqli_query($con,"SELECT * FROM products");
                            echo '<h3>'.mysqli_num_rows($qu_prod).'</h3>';
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <?php
                            $qu_reUs=mysqli_query($con,"SELECT * FROM users");
                            echo '<h3>'.mysqli_num_rows($qu_reUs).'</h3>';
